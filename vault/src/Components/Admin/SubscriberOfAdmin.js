...
export default function SubscriberOfAdmin() {
  ...
  return (
    <div className="min-h-screen px-4 py-8 bg-gradient-to-br from-[#f9f871] via-[#fdd9e0] to-[#fce4ec] dark:from-gray-900 dark:to-black text-gray-900 dark:text-white overflow-hidden">
